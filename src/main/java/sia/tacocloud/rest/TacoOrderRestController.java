...
public class TacoOrderRestController {
    ...
    private final RabbitMqTacoOrderMessageSenderService messageSender;

    public TacoOrderRestController(TacoOrderService tacoOrderService, RabbitMqTacoOrderMessageSenderService messageSender) {
